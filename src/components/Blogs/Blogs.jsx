            ...
            <div class="QnA row mb-3">
                <div class="col-sm-6">
                    <div class="card m-5 bg-light">
                        <div class="card-body">
                            <h5 class="card-title">Question-01:When should you use context API?</h5>
                ...
                <div class="col-sm-6">
                    <div class="card m-5 bg-light">
                        <div class="card-body">
                            <h5 class="card-title">Question-02: What is a custom hook?</h5>
                ...
                <div class="col-sm-6">
                    <div class="card m-5 bg-light">
                        <div class="card-body">
                            <h5 class="card-title">Question No-4: What is useMemo?</h5>
                            <p class="card-text">React has a built-in hook called useMemo that allows you to memoize expensive functions so that you can avoid calling them on every render. You simple pass in a function and an array of inputs and useMemo will only recompute the memoized value when one of the inputs has changed.</p>
